code segment	'code'
	...
	; данные
	ignoredChars 				DB	'0123456789'	; список игнорируемых символов
	...
	charToCursiveIndex 			DB 'Е'							; символ для замены
	...
	signatureLine1				DB	179, 'Винников Степан Сергеевич', 179
	Line1_length 					equ	$-signatureLine1
	signatureLine2				DB	179, 'ИУ5-42Б                   ', 179
	Line2_length 					equ	$-signatureLine2
	signatureLine3				DB	179, 'Вариант #9                ', 179
	Line3_length 					equ	$-signatureLine3
	helpMsg DB '>tsr.com [/?]', 10, 13
			DB ' [/?] - вывод данной справки', 10, 13
			DB ' повторный запуск программы - выгрузка резидента из памяти', 10, 13
			DB '  F6  - вывод ФИО и группы по таймеру в центре экрана', 10, 13
			DB '  F7  - включение и отключения курсивного вывода русского символа Е', 10, 13
			DB '  F8  - включение и отключение частичной русификации клавиатуры (}SM">Z -> ЪЫЬЭЮЯ)', 10, 13
			DB '  F9  - включение и отключение режима замены ввода цифр на *', 10, 13
...
new_int1Ch proc far
	...
	cmp signaturePrintingEnabled, true ; если нажата управляющая клавиша (в данном случае F4)
	jne _notToPrint		
